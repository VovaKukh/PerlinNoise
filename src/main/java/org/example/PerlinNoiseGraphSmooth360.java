...
public class PerlinNoiseGraphSmooth360 extends Application {
    ...
    public void start(Stage stage) {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            double angleValue = (noiseValue + 0.5) * 360; // Map noise value to 0 to 360 degrees
            series.getData().add(new XYChart.Data(i, angleValue));
        }
